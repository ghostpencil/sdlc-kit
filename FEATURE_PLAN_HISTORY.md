# Feature Plan — history (§1–§30, 2026-07-19 → 2026-08-03)

Retired sections of `FEATURE_PLAN.md`, moved here 2026-08-05 so the live plan stays
readable. **Section numbers are preserved** — any document (CHANGELOG entries, field
reports, the live plan) citing `FEATURE_PLAN.md` §N for N ≤ 30 means this file. Nothing
